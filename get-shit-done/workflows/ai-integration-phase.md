...
```markdown
Read ~/.claude/agentsgsd:framework-selector.md for instructions.
...
```markdown
Read ~/.claude/agentsgsd:ai-researcher.md for instructions.
...
```markdown
Read ~/.claude/agentsgsd:domain-researcher.md for instructions.
...
```markdown
Read ~/.claude/agentsgsd:eval-planner.md for instructions.
